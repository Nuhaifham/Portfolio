...
import { 
  ArrowUp, Mail, Phone, MapPin, Globe, ExternalLink, Download,
  Layers, Palette, Shield, Code, Settings, Terminal, Database,
  Smartphone, Monitor, Lightbulb, UserCheck, Activity, Atom, Send, Compass
} from "lucide-react";
...
const skillsData = [
  ...
  { name: "Interaction Design", icon: <span className="text-[#0055FF]">🔄</span> },
  ...
  { name: "Express.js", icon: <span className="text-[#181717] dark:text-white">🚂</span> },
  ...
  { name: "Adobe Illustrator", icon: <span className="text-[#ff9a00]">🖌️</span> },
...
const projectsData = [
  ...
  {
    title: "Eventaa",
    description: "A premium Flutter application for discovering and booking local events. Integrates Google Gemini AI as a conversational assistant, Supabase Auth for security, and real-time database syncing.",
  ...
  {
    title: "SEUSL Connect",
    description: "A smart campus platform designed to make student life connected and efficient. Includes an AI assistant, timetable organizer, notices, course resources, and student services.",
  ...
  {
    title: "EcoTrack",
    description: "A household resource-tracking and management mobile application encouraging water, waste, and energy efficiency through clean visualizations and reminders.",
  ...
  {
    title: "CampusMate",
    description: "Student campus companion mobile app helping university students browse event listings, cafeteria menus, and grade statistics with minimal cognitive load.",
  ...
  },
  {
    ...
    description: "Clean, responsive storefront website layout featuring custom illustration overlays, dynamic card animations, and unified styling systems.",
  ...
  },
  {
    ...
    description: "Full-stack web application designed for appointment scheduling, customer queuing, time-slot selection, and database logging.",
  ...
  {
    title: "TechDesk",
    description: "Helpdesk support ticketer and team communication application built to log client technical problems and assign them to support reps.",
    ...
    <div className="flex overflow-x-hidden min-h-screen relative font-sans">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80vw] max-w-[800px] opacity-10 dark:opacity-[0.03] mix-blend-overlay">
          <span className="text-[12vw] font-heading font-extrabold text-[var(--color-primary)] select-none">NI</span>
        </div>
      ...
      <div className="flex w-full relative">
        ...
        <main className="flex-1 lg:ml-64 w-full lg:w-[calc(100%-16rem)] overflow-x-hidden relative flex flex-col min-h-screen pt-16 lg:pt-0 z-10 bg-slate-50 dark:bg-[#08060d] transition-colors duration-300 font-sans">
          ...
          {/* HOME HERO SECTION */}
          <Element name="home" className="min-h-screen flex items-center justify-center py-20 px-6 sm:px-12 relative overflow-hidden">
            <div className="max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
              ...
              >
                ...
                <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white mb-4 leading-tight font-heading">
                  Nuha Ifham<span className="text-[var(--color-primary)]">.</span>
                </h1>
                <h3 className="text-2xl sm:text-3xl font-semibold text-[var(--color-primary)] mb-6 h-12">
                  I'm a <span className="underline decoration-wavy decoration-purple-500/50">{animatedRole}</span>
                </h3>
                <p className="text-gray-650 dark:text-gray-300 leading-relaxed mb-8 max-w-lg text-base">
                  I'm a dedicated, conscientious, and energetic Software Developer and UI/UX Designer. Working on startup initiatives like Zatroz and winning university designathons has enabled me to build a high-end visual aesthetic and bridge it with robust technical implementations.
                </p>
                    ...
                    <div className="glass-card p-4 sm:p-6 rounded-[2.5rem] !overflow-visible relative">
                      ...
                      >
                        <motion.img
                          ...
                          transition={{ layout: { duration: 1.5, ease: [0.6, 0.01, -0.05, 0.9] } }}
          ...
          {/* ABOUT SECTION */}
          <Element name="about" className="py-20 px-6 sm:px-12 relative border-t border-gray-100 dark:border-gray-800/50">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
                <div className="lg:col-span-7 flex flex-col justify-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
                    I am currently pursuing my BSc(Hons) in Software Engineering. Over the past few years, I have successfully balanced core academic concepts with hands-on startup execution, serving as the Chief Operating Officer at Zatroz.
                  </p>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    My design philosophy focuses on clean, intuitive layouts that reduce user friction. My engineering philosophy focuses on robust, testable, and highly responsive codebases. By maintaining a foot in both design and development worlds, I write systems that work exactly the way they look.
                  </p>
                </div>
          ...
          <Element name="experience" className="py-20 px-6 sm:px-12 relative border-t border-gray-100 dark:border-gray-800/50">
            <div className="max-w-5xl mx-auto">
          ...
          <Element name="portfolio" className="py-20 px-6 sm:px-12 relative border-t border-gray-100 dark:border-gray-800/50 min-h-screen">
            <div className="max-w-5xl mx-auto">
              <SectionHeader title="Portfolio" subtitle="Showcase" alignment="center" />
          ...
          {/* CONTACT SECTION */}
          <Element name="contact" className="py-20 px-6 sm:px-12 relative border-t border-gray-100 dark:border-gray-800/50">
            <div className="max-w-5xl mx-auto">
              <SectionHeader title="Contact Me" subtitle="Get in touch" alignment="center" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                <div className="p-6 bg-white/40 dark:bg-gray-800/40 backdrop-blur-xl rounded-3xl border border-white/60 dark:border-gray-700/60 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex flex-col items-center text-center">
                  ...
                  <h5 className="font-extrabold text-sm text-gray-900 dark:text-white uppercase mb-1">WhatsApp</h5>
                  <p className="text-xs text-gray-500 dark:text-gray-400 font-semibold hover:text-[var(--color-primary)]">
                    <a href="https://wa.me/94773299615" target="_blank" rel="noopener noreferrer">+94 77 329 9615</a>
                  </p>
                </div>
                ...
                <div className="p-6 bg-white/40 dark:bg-gray-800/40 backdrop-blur-xl rounded-3xl border border-white/60 dark:border-gray-700/60 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex flex-col items-center text-center">
                  ...
                  <h5 className="font-extrabold text-sm text-gray-900 dark:text-white uppercase mb-1">Location</h5>
                  <p className="text-xs text-gray-500 dark:text-gray-400 font-semibold">Kurunegala, Sri Lanka</p>
                </div>
                ...
                <div className="p-6 bg-white/40 dark:bg-gray-800/40 backdrop-blur-xl rounded-3xl border border-white/60 dark:border-gray-700/60 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex flex-col items-center text-center">
                  ...
                  <h5 className="font-extrabold text-sm text-gray-900 dark:text-white uppercase mb-1">Website</h5>
                  <p className="text-xs text-gray-500 dark:text-gray-400 font-semibold hover:text-[var(--color-primary)]">
                    <a href="https://www.nuhaifham.com" target="_blank" rel="noopener">nuhaifham.com</a>
                  </p>
                </div>
              </div>
